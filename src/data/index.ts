...
export const aboutContent = {
  ...
  contact: {
    en: `Beyond research, Eddy is a <strong>violinist</strong> (Level 10, Sichuan Musicians Association), proudly advised by <a href="https://www.xiaohongshu.com/user/profile/5b82d671bced64000175907a?xsec_token=ABmARYBZrXyQ87uzzA7CCwODns1tLOerFGI4QDmBSDK9s%3D&xsec_source=pc_note">Yiwei Hu</a>. Eddy warmly welcomes collaboration opportunities and supports undergraduates who want to apply for a PhD program. He hopes we can conduct significant research together. Please feel free to contact him at <strong>Email: luo.1455[shift+2]uga[dot]edu</strong>. どうぞよろしくお願いします!`,
    zh: `除了研究之外，Eddy还是一名<strong>小提琴手</strong>（四川省音乐家协会十级），师从<a href="https://www.xiaohongshu.com/user/profile/5b82d671bced64000175907a?xsec_token=ABmARYBZrXyQ87uzzA7CCwODns1tLOerFGI4QDmBSDK9s%3D&xsec_source=pc_note">胡艺伟老师</a>。Eddy热忱欢迎合作机会，并支持想要申请博士项目的本科生。他希望我们能够一起进行重要的研究。请随时通过<strong>邮箱：luo.1455[shift+2]uga[dot]edu</strong>联系他。どうぞよろしくお願いします!`
  },
  researchTitle: {
